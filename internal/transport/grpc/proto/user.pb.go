...
const file_user_proto_rawDesc = "" +
	...
	"\n" +
	"DeleteUser\x12\x17.user.DeleteUserRequest\x1a\x18.user.DeleteUserResponseB@Z>github.com/abrshDev/user-service/internal/transport/grpc/protob\x06proto3"
